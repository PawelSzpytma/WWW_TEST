...
namespace WWW.Api
{
    ...
    public partial class ApiClient 
    {
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        [DotVVM.Framework.Configuration.RestApiRegistrationHelpers.HttpMethod("Get")]
        [DotVVM.Framework.Configuration.RestApiRegistrationHelpers.MethodUrl("WeatherForecast/GetCountries")]
        [DotVVM.Framework.Configuration.RestApiRegistrationHelpers.AutoRefreshKey("WeatherForecast")]
        public System.Collections.Generic.ICollection<string> GetGetCountries()
        {
            return System.Threading.Tasks.Task.Run(async () => await GetGetCountriesAsync(System.Threading.CancellationToken.None)).GetAwaiter().GetResult();
        }
        ...
        [DotVVM.Framework.Configuration.RestApiRegistrationHelpers.MethodUrl("WeatherForecast/GetCountries")]
        [DotVVM.Framework.Configuration.RestApiRegistrationHelpers.AutoRefreshKey("WeatherForecast")]
        public async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<string>> GetGetCountriesAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/WeatherForecast/GetCountries");
